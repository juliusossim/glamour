...
export const defaultProduct = {
  ...
  price: { min: 199.99, best: 149.99 },
  discount: 25,
  category: 'Electronics',
  imageUrls: [
    'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=500',
    'https://videos.unsplash.com/photo-1523275335684-37898b6baf30?w=500',
    'https://videos.pexels.com/video-files/8003609/8003609-uhd_2560_1440_25fps.mp4',
...
export const defaultBrands = [
  ...
  },
  {
    ...
    className: 'text-yellow-500',
    description:
      "Governor's Consent from the state Governor, authorizing land use free from all government acquisitions.",
  },
];
...
export const defaultReview = {
  ...
  content:
    'I absolutely love these headphones. The sound quality is amazing and the noise cancellation works wonders. Highly recommend!',
